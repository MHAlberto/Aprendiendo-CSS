...
```
También podemos usar el caso de RGB y nos ofrece una particularidad que nos puede permitir dencantarnos más por este valor,
nos permite que el color del texto elegir la opacidad solamente cambiando un paramétro.
```CSS
p {
  color: rgb(194, 64, 39);
}
